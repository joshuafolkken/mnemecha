...
describe('board center label line heights', () => {
	it('MULTILINE_LINE_HEIGHT pins the GAME OVER breathing room at 1.4', () => {
		expect(MULTILINE_LINE_HEIGHT).toBeCloseTo(1.4)
	})
